...
Также для работы pytesseract необходимо по ссылке https://github.com/UB-Mannheim/tesseract/wiki скачать установщик tesseract.exe и указать в файле main.py в переменную pytesseract.pytesseract.tesseract_cmd путь до него.
